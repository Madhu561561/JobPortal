...
// Query the JobType collection to find all documents and retrieve only their _id fields
// Loop through each document (category) and push its _id into the ids array
// Get the category query parameter from the request
// If the category query parameter is not empty, use it; otherwise, use the full list of category IDs
*/
    let ids = [];
